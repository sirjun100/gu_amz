...
const adClickChildren: NavItem[] = [
  ...
  { icon: Megaphone, label: '全广告品牌黑名单模式', path: '/tasks/search-click-app' },
  { icon: Megaphone, label: 'SP常规广告品牌黑名单模式', path: '/tasks/sp-vertical-ad-double-keywords-3min' },
  ...
  { icon: BarChart3, label: '全广告品牌黑名单模式结果', path: '/app-ad-click-stats' },
