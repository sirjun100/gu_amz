...
const routeTitles: Record<string, string> = {
  ...
  '/tasks/search-click-app': '全广告品牌黑名单模式',
  '/tasks/sp-vertical-ad-double-keywords-3min': 'SP常规广告品牌黑名单模式',
  ...
  '/keyword-click-stats': '关键词点击统计',
  '/asin-click-records': 'ASIN 点击记录',
  '/app-ad-click-stats': '全广告品牌黑名单模式结果',
  '/app-ad-click-records': 'APP广告点击记录',
  '/settings': '系统设置',
